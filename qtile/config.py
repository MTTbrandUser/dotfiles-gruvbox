...
keys = [
    ...
    Key([mod, "shift"], "return", lazy.spawn(fileExplorer), desc="Launch file explorer"),
    Key([mod, "shift"], "r", lazy.spawn(appLauncher), desc="Launch app launcher"),
    ...
    Key([mod, "shift"], "p", lazy.spawn(powerMenu), desc="Open power menu"),
...
layouts = [
    layout.MonadTall(border_width=0, margin=6, fair=False),
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.TextBox("  ", background=background),
            ],
            28,
            background = background,
            opacity = 0.95,
